    ...
    for index, row in df.iterrows():
        try:
            ...
            if result:
                ...
                cursor.execute(
                    "INSERT INTO ingredientinfo (date, price, ingredient_id, ingredient_info_id) VALUES (%s, %s, %s, %s)",
                    (row['date'], row['price'], ingredient_id, index + 1)  # index + 1로 ingredient_info_id 자동 증가
                )
