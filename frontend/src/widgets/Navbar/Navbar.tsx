...
import { FaCarrot, FaUtensils, FaHeart, FaBars } from 'react-icons/fa';
    ...
    <nav className="bg-background-light fixed top-0 left-0 right-0 z-50 border-b border-peach">
      ...
      {isOpen && (
        <div className="md:hidden bg-background-light">
          <Link to="/" className="block py-2 px-4 text-sm hover:bg-peach-light">
            홈
          </Link>
          <Link
            to="/ingredients"
            className="block py-2 px-4 text-sm hover:bg-peach-light"
          >
            식재료
          </Link>
          <Link
