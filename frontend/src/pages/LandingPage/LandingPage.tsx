...
} from '@/shared/utils/landingPageUtils';
import {
  FaTag,
  FaUtensils,
  FaCarrot,
  ...
  const renderSection = (index: number) => {
    switch (index) {
          ...
          <div className="h-screen flex flex-col justify-center items-center px-4">
            ...
            <div className="max-w-4xl mx-auto grid grid-cols-2 gap-8">
              <div className="text-center">
                <FaTag className="w-16 h-16 mx-auto mb-4 text-coral" />
      ...
      case 2:
        return (
          <div
            className="h-screen flex flex-col justify-center items-center px-4 py-8"
            ref={cardRef}
          >
          ...
          <div className="h-screen flex flex-col justify-center items-center px-4">
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              <div className="flex items-center">
                <div className="w-1/2">
                  ...
                  <p>
                    메인 페이지에서 실시간으로 업데이트되는 식재료 가격을
                    확인하세요.
                  </p>
                </div>
                <div className="w-1/2 flex justify-center">
                  <FaSearch className="w-24 h-24 text-coral" />
                </div>
              </div>
              <div className="flex items-center flex-row-reverse">
                ...
                <div className="w-1/2 flex justify-center">
                  <FaListUl className="w-24 h-24 text-coral" />
                </div>
              </div>
              <div className="flex items-center">
                <div className="w-1/2">
                  ...
                  <p>
                    선택한 식재료를 기반으로 어울리는 재료와 레시피를
                    추천받으세요.
                  </p>
                </div>
                <div className="w-1/2 flex justify-center">
                  <FaThumbsUp className="w-24 h-24 text-coral" />
                </div>
              </div>
            </div>
            <div className="mt-12 text-center">
              ...
              <Link
                ...
                className="bg-coral text-white px-8 py-4 rounded-full font-semibold hover:bg-peach-dark transition duration-300 text-lg"
              >
                시작하기
              </Link>
